...
# Example watchlist
watchlist = ['AMD', 'AAPL', 'GOOGL', 'NVDA', 'CRWD', 'EWY', 'GLW', 'AVGO', 'PLTR', 'ORCL', 'LITE', 'MSFT', 'MU', 'IONQ', 'WDC', 'STX', 'KEEL', 'IREN', 'MP', 'BE', 'OKLO', 'SMR', 'RKLB', 'APP', 'OPEN', 'CRML', 'SNDK', 'PL', 'RGTI', 'CRWV', 'NBIS', 'CRDO', 'U', 'TSLA', 'FIG', 'IBIT', 'ETHE', 'TEAM', 'MSTR', 'KWEB', 'AXTI', 'CAR', 'SOXL', 'MRVL', 'META', 'INTC', 'BRUN','MXL', 'SIMO', 'STM', 'ON', 'NVTS', 'NOK', 'DXYZ', 'QCOM', 'WOLF', 'RVI', 'AAOI','LWLG','FCEL']
