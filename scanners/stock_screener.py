...
# Example watchlist
watchlist = ['AMD', 'HQ','AAPL','SPCE','RXT','FJET', 'GOOGL', 'NVDA', 'CRWD', 'EWY', "BOT",'GLW', 'AVGO', 'PLTR', 'ORCL', 'LITE', 'MSFT','HYLN' ,'MU', 'IONQ', 'WDC', 'STX', 'KEEL', 'IREN', 'MP', 'BE', 'OKLO', 'SMR', 'RKLB', 'DGXX','APP', 'OPEN', 'CRML', 'SNDK', 'PL', 'RGTI', 'CRWV', 'NBIS', 'CRDO','POET', 'U', 'TSLA', 'FIG', 'IBIT', 'ETHE', 'TEAM', 'MSTR', 'KWEB', 'AXTI', 'CBRS','SOXL', 'MRVL', 'META', 'INTC', 'BRUN','MXL', 'SIMO', 'STM', 'ON', 'NVTS', 'NOK', 'DXYZ', 'QCOM', 'WOLF', 'RVI', 'AAOI','LWLG','FCEL', 'ARM', 'ALAB', 'UMC', 'AMAT', 'INOD', 'BABA', 'SKHY', 'DRAM', 'PENG', 'SPCX']
