"""
Fix pct_change_3/15/30/90/120 in bounce_data.csv to use TRADING days.

Same calendar-day bug as reversal_data.csv — get_price_with_fallback() was using
calendar day lookback instead of trading day counts.
"""
import sys
import os
...
def main():
    ...
    backup_path = DATA_DIR / 'bounce_data_pre_trading_day_fix.csv'

    df = pd.read_csv(csv_path, on_bad_lines='warn')
    print(f"Loaded {len(df)} rows from bounce_data.csv")
